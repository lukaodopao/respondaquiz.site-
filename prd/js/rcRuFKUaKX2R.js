! function t(n, e, i) {
	...
	5: [function(t, n, e) {
		...
		i(), $("form#cart-form ul.animated-list li.animate__animated").length && enterView({
			...
			n.addClass("show"), $.post("/cart/change.js", {
			...
			t.preventDefault();
			$(this).closest("form#cart-form").find(".container-loading").addClass("show"), $.post("/cart/change.js", {
			...
			t.addClass("show"), $.post("/cart/change.js", {
				line: Number($(this).closest(".modal-product-list-item").data("line-item-id")),
				quantity: $(this).val()
			}, (function(n) {
	...
	12: [function(t, n, e) {
		window.initLazyLoading = function() {
			if ("loading" in document.createElement("img")) {
				...
				t.src = "https://cdn.jsdelivr.net/npm/lazysizes@5.3.2/lazysizes.min.js", document.body.appendChild(t)
			}
			$("[data-lazy-img]").each((function() {
				$(this).css("background-image", `url(${$(this).data("lazy-img")})`), $(this).removeAttr("data-lazy-img")
			}))
	...
	22: [function(t, n, e) {
		window.initProductStickyATC = function() {
			...
			n.prop("disabled", !0), n.find(".add-to-cart-btn-icon").hide(), n.find(".add-to-cart-btn-spinner").show(), n.find(".add-to-cart-btn-text-add").hide(), n.find(".add-to-cart-btn-text-loading").show(), $.post("/cart/add.js", {
				items: [{
					id: e,
					quantity: 1
				}]
		...
		window.initProductGallerySticky = function() {
			...
			n.prop("disabled", !0), "buttonBuy" === i ? (n.find(".buy-now-btn-icon").hide(), n.find(".buy-now-btn-spinner").show(), n.find(".buy-now-btn-text-add").hide(), n.find(".buy-now-btn-text-loading").show()) : (n.find(".add-to-cart-btn-icon").hide(), n.find(".add-to-cart-btn-spinner").show(), n.find(".add-to-cart-btn-text-add").hide(), n.find(".add-to-cart-btn-text-loading").show()), $.post("/cart/add.js", $(this).serialize(), (function(t) {
				...
				$("#toast").toast("dispose"), $("#product-sticky-atc").toast("hide"), $.get(window.location, (function(t) {
					$("#nav-item-cart").replaceWith($(t).find("#nav-item-cart")), $("#cart-modal .modal-content").replaceWith($(t).find("#cart-modal .modal-content")), initInputSpinner(), "buttonAdd" === i ? $("#cart-modal").modal("show") : window.location.href = "/cart"
